...
| 2 | Crear cliente | ✅ | Cliente 'Cliente Prueba' guardado |
| 3 | Entrar al cliente | ✅ | Detalle del cliente abierto |
| 4 | Crear varios tanques | ✅ | Cliente con 2 tanques (uno completo y uno borrador) |
| 5 | Completar un levantamiento (asistente 8 pasos) | ✅ | Pasos 1–6 completados con los 7 datos principales |
| 6 | Guardar el levantamiento | ✅ | Guardado; resumen con 7 / 7 datos y estado completado |
